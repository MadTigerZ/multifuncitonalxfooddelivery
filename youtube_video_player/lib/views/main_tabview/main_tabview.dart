...
import 'package:youtube_video_player/common_widget/tab_button.dart';
...
class _MainTabViewState extends State<MainTabView> {
  ...
  Widget selectPageView = const RestaurantPage();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("F O O D  M O N K E Y  D E L I V E R Y"),
      ),
      ...
      floatingActionButton: SizedBox(
        ...
        child: FloatingActionButton(
          onPressed: () {
            if (selctTab != 2) {
              selctTab = 2;
              selectPageView = const RestaurantPage();
            }
            if (mounted) {
              setState(() {});
            }
